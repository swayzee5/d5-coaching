...
export default async function AppClientDetailPage({ params }: { params: { id: string } }) {
  ...
  const serializedTemplates = programTemplates.map((t) => ({ ...t, session_count: Number(t.session_count) }));
        ...
        <div className="flex items-start justify-between mt-4">
          ...
          <div className="flex gap-2 shrink-0 flex-wrap justify-end">
            <form action={toggleRebootOnlyAction}>
              <button type="submit" className={`px-4 py-2 text-xs font-semibold rounded-lg text-white transition-colors ${
                client.isRebootOnly ? "bg-brand-500 hover:bg-brand-600" : "bg-gray-700 hover:bg-gray-600"
              }`}>
          ...
          <div className="mb-5">
            <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
              <div
                ...
                style={{ width: `${Math.round((rebootTotal / 10) * 100)}%` }}
              />
            </div>
          </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-2.5">
                  Séances — {seancesProgress}/3 complétées
                </p>
              ...
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-2.5">
                  Messages WhatsApp — {waProgress}/3 envoyés
                </p>
              ...
              {rebootActivity.modules.length > 0 && (
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wider mb-2.5">
                    Modules lifestyle — {modulesProgress}/4 validés
                  </p>
