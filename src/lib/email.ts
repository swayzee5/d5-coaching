...
// l'import. Comme ce module est importe par des routes et des server actions,
// l'absence de RESEND_API_KEY faisait echouer `next build` pendant la collecte
// des pages, et pas seulement l'envoi d'un email.
